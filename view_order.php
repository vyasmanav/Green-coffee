    ...
    <div class="main">
        ...
        <section class="order-detail">
               <div class="title">
                    ...
                    <h1>order detail</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum quaerat nostrum dicta error blanditiis aliquid necessitatibus exercitationem sint voluptas similique?
                    </p>
               </div>
               ...
               <?php
                ...
                <div class="box">
                    <div class="col">
                        <p class="title"><i class="bi bi-calendar"></i><?= $fetch_order['date']; ?></p>
                    ...
                    <?php } else { ?>
                        <form method="post">
                            <button type="submit" name="cancel" class="btn" onclick="return confirm('do you want to cancle this order')">cancle order</button>
                        </form>
