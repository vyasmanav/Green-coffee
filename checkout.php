    ...
    <div class="main">
        ...
        <section class="checkout">
             <div class="title">
                ...
                <h1>Checkout Summary</h1>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cum quisquam voluptatibus sit minus eum praesentium</p>
            </div>
                <div class="row">
                        ...
                        <div class="flex">
                            ...
                            <div class="box">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" name="pincode" required maxlength="6" placeholder="110022" max="999999" class="input">
                                </div>     
                            </div>
                        </div>
